package com.example.myForm.controller;

import org.springframework.web.bind.annotation.RestController;

import com.example.myForm.dto.ArticleRequest;
...
//	http://localhost:8090/article-get?title=제목입니다&content=내용입니다
	@GetMapping("/article-get")
	public String articlePost(@RequestParam String title, @RequestParam String content) {
		String result = "제목: " + title + "\n" + "<br>내용: " + content;
		return result;
	}
	
//	Form화면 테스트 가능
//	http://localhost:8090/article-post
...
//포스트맨 테스트
//	http://localhost:8090/article-postman
...
//	http://localhost:8090/article-auto
